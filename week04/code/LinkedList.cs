...
public class LinkedList : IEnumerable<int>
{
    ...
    {
        // Create new node.
        Node newNode = new(value) { Prev = _tail };

        // Connect node to old tail.
        if (_tail != null)
            _tail.Next = newNode;
    ...
    public void RemoveTail()
    {
        ...
        {
            _tail.Prev!.Next = null;    // Disconnect tail node.
    ...
    public void Remove(int value)
    {
        ...
        while (curr != null)
        {
            if (curr.Data == value)
            {
                ...
                // the node and reconnect the links.
                else
                {
                    curr.Prev!.Next = curr.Next;    // Set link on previous
                    curr.Next!.Prev = curr.Prev;    // Set link on next
